  ...
  return (
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <header className="bg-gray-900 text-white text-center py-16 px-4">
        ...
        <a href="https://pay.hotmart.com/P100830030V" className="bg-orange-500 hover:bg-orange-600 transition px-6 py-4 rounded-xl text-white font-bold text-lg shadow-md">
      ...
      <main className="max-w-4xl mx-auto py-12 px-4 space-y-12">
        ...
        <section className="bg-white p-8 rounded-xl shadow text-center">
          ...
          <a href="https://pay.hotmart.com/P100830030V" className="mt-6 inline-block bg-orange-500 hover:bg-orange-600 transition px-6 py-4 rounded-xl text-white font-bold text-lg shadow-md">
            GARANTIR MEU GUIA
          </a>
        </section>
